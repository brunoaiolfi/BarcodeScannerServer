/*
  ...
  - You are about to drop the column `value` on the `ItemPurchase` table. All the data in the column will be lost.
  - Added the required column `totalValue` to the `ItemPurchase` table without a default value. This is not possible if the table is not empty.
